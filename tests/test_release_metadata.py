...
EXPECTED_PYTHON_VERSION = "1.0.0a1"
EXPECTED_DISPLAY_VERSION = "1.0.0-alpha"
PUBLISHED_BASELINE = "v0.9.1-alpha"
PUBLISHED_BASELINE_COMMIT = "721bd2ec98395f2be36a3b7ebb60c14bfa63c882"


class ReleaseMetadataTests(unittest.TestCase):
    def test_v1_candidate_is_consistent_without_claiming_publication(self):
        ...
        release_notes = (ROOT / "docs" / "RELEASE_NOTES_v1.0.0-alpha.md").read_text(encoding="utf-8")
        ...
        self.assertIn("v1.0.0 Alpha Operator Console", dashboard)
        self.assertIn("version: 1.0.0-alpha", citation)
        self.assertIn("## v1.0.0-alpha Candidate", roadmap)
        self.assertIn("## Published v0.9.1-alpha", roadmap)
        self.assertIn("## [1.0.0-alpha] - Candidate", changelog)
        self.assertIn("**Local candidate:** `v1.0.0-alpha`", fact_sheet)
        self.assertIn("**Current public prerelease:** [`v0.9.1-alpha`]", fact_sheet)
        self.assertIn("## v1.0.0-alpha Candidate", readme)
        self.assertIn("Current public assets: v0.9.1-alpha", readme)
        self.assertIn("Project Reality", launch_site)
        self.assertIn("project-reality-v1.png", launch_site)
        ...
        self.assertIn("Local candidate only", release_notes)
        self.assertIn("No v1 tag", release_notes)
        self.assertIn("## v1.0.0-alpha Candidate Verification", release_verification)
        self.assertIn("No formal `v1.0.0-alpha` tag", release_verification)
