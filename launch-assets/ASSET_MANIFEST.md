...
| `screenshots/operator-capture-v1.0.2.png` | 1440x900 | Retained Universal Capture flight recorder |
| `screenshots/operator-cognition-v1.0.2.png` | 1440x900 | Retained Project Reality and Project Twin cockpit |
| `screenshots/operator-graph-mobile-v1.0.2.png` | 390x844 | Retained mobile graph layout proof |
...
The original `rta-smriti-v0.9-launch-*` media and `*-v0.9.png` screenshots are retained as historical release artifacts. They are not the current product presentation.
